  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        <p><img border="0" src="<?php bloginfo('template_url'); ?>/images/alipay.jpg" alt="武镖支付宝" width="180" height="180" style="margin: 0 8%;"><img border="0" src="<?php bloginfo('template_url'); ?>/images/wechat.png" alt="武镖微信钱包" width="180" height="180" style="margin: 0 8%;"></p>
        <p>扫描二维码，输入您要打赏的金额</p>
      </div>
    </div>
  </div>
